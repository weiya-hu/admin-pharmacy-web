<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="操作人员" prop="updateBy">
        <el-input
    ...
    >
      ...
      <el-table-column
        ...
        :show-overflow-tooltip="true"
      />
      <el-table-column label="按钮名称" prop="btnName" width="100">
        <template #default="scope">
          <!-- <dict-tag :options="sys_notice_type" :value="scope.row.btnName" /> -->
          <el-tag>{{ scope.row.btnName }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="创建者" prop="updateBy" width="100" />
      <el-table-column
        label="备注"
        prop="remark"
        :show-overflow-tooltip="true"
...
const data = reactive({
  ...
  rules: {
    ...
    btnName: [
      { required: true, message: "按钮名称不能为空", trigger: "change" },
    ],
  },
});
const btnNames = ref(
